...
|-----|-----|-----|-----|-----|-----|
| 9 (−1) | 15 (+2) | 15 (+2) | 12 (+1) | 18 (+4) | 10 (+0) |

- **STR 9** — wiry, not strong
- **DEX 15** — bare feet on wet rope
- **CON 15** — weathered hull
- **INT 12** — reads weather like a book
- **WIS 18** — *listens to the deep*
- **CHA 10** — quiet company

*She came to her WIS the hard way — three nights adrift on a splintered spar after the* Marrow-Gull *went down, watching the stars wheel and the water answer questions she'd never thought to ask.*
...
- **Ideal:** The tide doesn't take sides. Neither should anyone who's seen it work.
- **Bond:** A waterlogged journal kept in oilcloth, containing the names of every crewmate of the *Marrow-Gull* and a promise to find one of them — Henda — who may still be alive.
- **Flaw:** She trusts birds, fish, and weather more than people, and it shows on her face before she can hide it.

### Connections
- **Ally — Captain Oyemi Vasht:** The old riverboat captain who fished Iyari off the spar and didn't ask questions; she still sends letters care of any port druid grove, and Iyari owes her three favors and a sextant.
