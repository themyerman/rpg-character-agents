## **Nasrin "Nas" al-Qadeer**

| | |
|---|---|
| **UPP** | 6C8A96 |
| **Age** | 26 |
| **Homeworld** | Kharaz IV — Desert World |
| **Career** | Scouts (Scout — 2 terms, mustered out after misjump incident) |

### Characteristics
- **STR 6** — wiry, not strong
- **DEX 12 (C)** — *extraordinary* reflexes, the kind of hands that pull a stick out of a stall
- **END 8** — desert-tough
- **INT 10 (A)** — sharp, quick-learning
- **EDU 9** — self-taught, mostly on long courier hops
- **SOC 6** — raised poor, now a quietly respected veteran

### Skills
- Pilot (Spacecraft) 1
- Astrogation 1
- Vacc Suit 1
- **Language 2** (plus her native tongue — speaks at least four languages fluently, picks up new ones in weeks)
- Survival 1
- Recon 1
- Athletics 1

### Career History
- **Term 1 (18–22):** Recruited off Kharaz IV for her astonishing reflexes. Flew diplomatic courier routes through the Spinward marches. Spent layovers in dockside cantinas trading words for drinks.
- **Term 2 (22–26):** Senior courier run went catastrophically wrong — a misjump dropped her into uncharted space with a dead reactor. Survived 31 days alone in a freezing scout before a Vilani free-trader crew recovered her. She spent the long ride home learning their creole pidgin. The Scout Service awarded her a quiet commendation, the keys to her ship, and an early discharge.

### Muster Out
- **Cr60,000** in severance
- **High Passage** ticket (unused, folded in her jacket)
